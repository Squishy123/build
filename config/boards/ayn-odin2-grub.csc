...
declare -g KERNEL_TARGET="current,edge,ayn"
...
function post_family_tweaks__ayn-odin2_enable_services() {
	...
	if [[ "${RELEASE}" == "jammy" ]] || [[ "${RELEASE}" == "noble" ]] || [[ "${RELEASE}" == "plucky" ]] || [[ "${RELEASE}" == "quokka" ]]; then
	...
	if [[ "${RELEASE}" == "jammy" ]] || [[ "${RELEASE}" == "noble" ]] || [[ "${RELEASE}" == "plucky" ]] || [[ "${RELEASE}" == "quokka" ]] || [[ "${RELEASE}" == "trixie" ]]; then
